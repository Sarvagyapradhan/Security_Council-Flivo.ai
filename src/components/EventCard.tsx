  ...
  return (
    <div className="w-[419px] h-[550px] relative">
      ...
      <img
        ...
        alt={event.title}
        className="w-[418px] h-[550px] object-cover absolute left-0 top-0"
      />
      
      {/* Date/Location Header */}
      <div className="absolute left-0 top-[30px] w-[418px] h-[88px] bg-[#0050AC] border border-white shadow-lg flex flex-col items-center justify-center">
      ...
      {/* Content Overlay */}
      <div className="absolute left-0 top-[289px] w-[418px] h-[261px] border border-white bg-gradient-to-b from-blue-900/10 to-blue-900/25 shadow-lg flex flex-col items-center justify-center text-center px-6">
        <h3 className="text-white font-bold text-[32px] leading-[38px] mb-4 max-w-[362px]">
          {event.title}
        </h3>
        <p className="text-white font-normal text-[16px] leading-[25px] max-w-[374px]">
          {event.description}
        </p>
      </div>
