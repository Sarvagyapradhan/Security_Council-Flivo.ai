...
const TempHome: React.FC = () => (
    <main>
		...
		{false && (
			<section className="relative bg-white overflow-x-hidden" aria-label="Secondary hero">
				<div className="relative mx-auto w-[1440px] h-[575px]">
					{/* Image occupies most of the section height, leaving white band at bottom */}
					<div className="absolute top-0 left-1/2 -translate-x-1/2 w-screen max-w-none h-[540px]">
						<OptimizedImage
							src="/homepage/Section 5/background image.webp"
							alt="Section 2 background"
							className="h-full w-full object-cover"
							eager
						/>
						{/* Dark blue overlay gradient */}
						<div className="absolute inset-0 pointer-events-none bg-[rgba(0,40,86,0.5)]" />
						{/* Bottom 40% solid blue cover */}
						<div className="absolute bottom-0 left-0 right-0 h-[40%] pointer-events-none bg-[rgba(0,40,86,1)]" />
					</div>
					{/* Foreground content over background */}
					<div className="relative z-10 h-[540px] flex items-end px-8">
						<div className="flex w-full items-end justify-between gap-8">
							{/* Left text block */}
							<div className="text-white max-w-[420px] mb-8">
								<h3 className="text-[32px] font-extrabold leading-tight">CTI Highlights & Reports</h3>
								<p className="mt-3 text-[14px] leading-relaxed text-white/90">
									Security Council doesn’t lead with assumption, we lead with
									research intelligence.
								</p>
								<a href="#" className="mt-5 inline-flex items-center gap-2 rounded-md bg-white/10 px-4 py-2 text-sm font-semibold ring-1 ring-inset ring-white/30 backdrop-blur hover:bg-white/20">
									Explore more Reports <span className="translate-y-[1px]" aria-hidden>↗</span>
								</a>
							</div>
							...
							<div className="flex-1 grid grid-cols-3 gap-6 mb-8">
								{/* Card 1 */}
								<div className="relative rounded-md overflow-hidden ring-1 ring-black/20 bg-white/5">
									<OptimizedImage
										src="/homepage/Section 5/card image1.webp"
										alt="AI-Powered Threats"
										className="block w-full h-[220px] object-cover"
										eager
									/>
									<div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,157,255,0.6)_72.21%)]" />
									<div className="absolute top-4 left-4 right-4">
										<div className="bg-white rounded-md px-4 py-3 shadow">
											<p className="text-[#0A2A57] text-[16px] font-semibold leading-snug">AI-Powered
												<br />Threats: 12-Month
												<br />Research Analysis</p>
										</div>
									</div>
									<div className="absolute bottom-4 left-4">
										<a href="#" className="inline-flex items-center bg-white text-[#0A2A57] font-semibold text-sm rounded-md px-3 py-2 shadow">
											View Research Findings <span className="ml-1 translate-y-[1px]" aria-hidden>↗</span>
										</a>
									</div>
								</div>
								...
								<div className="relative rounded-md overflow-hidden ring-1 ring-black/20 bg-white/5">
									<OptimizedImage
										src="/homepage/Section 5/card image2.webp"
										alt="Emerging Threat Actor"
										className="block w-full h-[220px] object-cover"
										eager
									/>
									<div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,157,255,0.6)_72.21%)]" />
									<div className="absolute top-4 left-4 right-4">
										<div className="bg-white rounded-md px-4 py-3 shadow">
											<p className="text-[#0A2A57] text-[16px] font-semibold leading-snug">Emerging Threat Actor
												<br />Analysis: Real-Time
												<br />Intelligence Report</p>
										</div>
									</div>
									<div className="absolute bottom-4 left-4">
										<a href="#" className="inline-flex items-center bg-white text-[#0A2A57] font-semibold text-sm rounded-md px-3 py-2 shadow">
											Read Intelligence Brief <span className="ml-1 translate-y-[1px]" aria-hidden>↗</span>
										</a>
									</div>
								</div>
								...
								<div className="relative rounded-md overflow-hidden ring-1 ring-black/20 bg-white/5">
									<OptimizedImage
										src="/homepage/Section 5/card image3.webp"
										alt="Threat Intelligence Methodology"
										className="block w-full h-[220px] object-cover"
										eager
									/>
									<div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,157,255,0.6)_72.21%)]" />
									<div className="absolute top-4 left-4 right-4">
										<div className="bg-white rounded-md px-4 py-3 shadow">
											<p className="text-[#0A2A57] text-[16px] font-semibold leading-snug">Threat Intelligence
												<br />Methodology: Our
												<br />Research Approach</p>
										</div>
									</div>
									<div className="absolute bottom-4 left-4">
										<a href="#" className="inline-flex items-center bg-white text-[#0A2A57] font-semibold text-sm rounded-md px-3 py-2 shadow">
					...
					{/* Bottom white band (approx 35px of the 575px height) */}
					<div className="absolute bottom-0 left-0 right-0 h-[35px] bg-white" />
				</div>
			</section>
		)}
    </main>
