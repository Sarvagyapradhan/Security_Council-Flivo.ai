    ...
    <div className="bg-white">
      ...
      <section className="mx-auto w-full max-w-[1280px] px-4 sm:px-8 lg:px-0 mt-12 mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-[27px]">
          <div className="w-full max-w-[400px] lg:max-w-[402px] h-auto bg-white border border-[#002856]/56 rounded-[16px] sm:rounded-[20px] p-4 sm:p-6 flex flex-col">
            <h3 className="text-lg sm:text-xl lg:text-[24px] font-bold text-[#002856] leading-tight lg:leading-[28px] mb-3 sm:mb-4">Dark Web Ransomware Trends: 8-Month Intelligence Study</h3>
          ...
          <div className="w-full max-w-[400px] lg:max-w-[402px] h-auto bg-white border border-[#002856]/56 rounded-[16px] sm:rounded-[20px] p-4 sm:p-6 flex flex-col">
            <h3 className="text-lg sm:text-xl lg:text-[24px] font-bold text-[#002856] leading-tight lg:leading-[28px] mb-3 sm:mb-4">Credential Leak Intelligence: Analysis of 300+ Incidents</h3>
