...
const Insight5Page: React.FC = () => {
  const [isReportOpen, setIsReportOpen] = useState(false);
  return (
    <div className="bg-white">
      {/* Copied from Insight4Page: hero section */}
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          <div className="w-full lg:w xl:w">
            <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start">
              <div className="flex-1">
                <h1 className="mb-2 max-w-[34ch] text-3xl font-extrabold leading-tight tracking-tight text-[#002856] sm:max-w-[32ch] sm:text-4xl md:max-w-[30ch] md:text-5xl lg:max-w-[28ch] xl:max-w-[24ch]">
                  Financial Sector Risk Analysis: Emerging Threats
                </h1>
            ...
            <p className="mt-2 max-w-[78ch] text-base leading-7 text-slate-800 sm:max-w-[74ch] sm:text-lg sm:leading-8 md:max-w-[70ch] lg:max-w-none xl:max-w-none">
              The global financial sector continues to operate as a primary target for sophisticated cyber adversaries, facing a dynamic landscape characterized by a surge in identity-based attacks, evolving ransomware tactics, and amplified risks stemming from complex supply chains and expanding cloud infrastructure. A comprehensive 12-month analysis, spanning January 2024 to June 2025, reveals that while traditional threat vectors persist, the pervasive integration of Artificial Intelligence (AI) by threat actors is significantly accelerating the scale, realism, and efficacy of malicious operations, particularly in social engineering and financial fraud. This report meticulously details these emerging threats, dissects their technical underpinnings, and provides strategic and tactical recommendations designed to empower Chief Information Security Officers (CISOs) and Security Operations Center (SOC) teams in fortifying their defenses.
            </p>
            <p className="mt-4 max-w-[78ch] text-base leading-7 text-slate-800 sm:max-w-[74ch] sm:text-lg sm:leading-8 md:max-w-[70ch] lg:max-w-none xl:max-w-none">
              Key findings underscore that credential theft, frequently facilitated by advanced infostealers and highly deceptive phishing campaigns, has emerged as the leading initial access vector. This highlights a critical and immediate need for robust identity and access management frameworks. Concurrently, ransomware continues to present a severe operational and financial risk, with adversaries increasingly pivoting towards data exfiltration and multi-extortion schemes, often targeting interconnected systems to maximize impact. Furthermore, inherent vulnerabilities within cloud environments and extensive third-party dependencies represent systemic weaknesses that threat actors are actively exploiting, leading to widespread data breaches, significant financial losses, and critical service disruptions across the industry.
            </p>
            <p className="mt-4 max-w-[78ch] text-base leading-7 text-slate-800 sm:max-w-[74ch] sm:text-lg sm:leading-8 md:max-w-[70ch] lg:max-w-none xl:max-w-none">
              To effectively counter this rapidly evolving threat landscape, financial institutions must adopt a proactive, intelligence-driven security posture. Recommendations emphasize the imperative of implementing comprehensive Zero Trust principles, enhancing behavioral analytics for early detection of anomalous activities, rigorously managing third-party and supply chain risks, and strategically leveraging AI for defensive capabilities while simultaneously securing its own deployment. Furthermore, continuous, targeted security awareness training for all personnel and the development of agile, well-rehearsed incident response plans are paramount to building and maintaining resilience against these persistent and emerging threats.
            </p>
          </div>
        </div>
      </section>

      {/* Copied from Insight4Page: Key Findings section */}
      <section className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-start gap-8">
          <div className="w-full md:w-[35%]">
            <div className="mb-4 flex items-center gap-3">
              <h2 className="text-2xl font-bold leading-tight text-[#002856] sm:text-3xl">II. Key Findings</h2>
              <OptimizedImage src="/images/warning.webp" alt="Warning icon" className="h-24 w-24 sm:h-32 sm:w-32" />
            </div>
            <p className="text-slate-800 font-semibold text-base sm:text-lg md:text-xl leading-7">
              The Q2 2025 assessment reveals several critical trends and statistics shaping the healthcare cybersecurity landscape:
            </p>
          </div>
          <div className="relative w-full md:w-[65%] pl-4 lg:pl-8 border-l border-[#0000008F]">
            <div className="mt-6 space-y-6">
              <div>
                <h4 className="text-[#002856] font-semibold text-[20px] sm:text-[22px] md:text-[24px] leading-tight">Ransomware Activity:</h4>
                <p className="mt-2 text-base leading-7 text-slate-800 sm:text-lg sm:leading-8">
                  While global ransomware incidents decreased by 40% in Q2 2025 compared to Q1 (1,488 vs. 2,461 incidents), the healthcare industry specifically experienced 211 ransomware attacks in H1 2025, representing a 4% year‑on‑year increase from H1 2024. These attacks resulted in over 2.3 million records breached in confirmed incidents. A prominent example is the Frederick Health Medical Group breach in April, which affected nearly a million patient records.
                </p>
              </div>
              <div>
                <h4 className="text-[#002856] font-semibold text-[20px] sm:text-[22px] md:text-[24px] leading-tight">Data Breaches and Costs:</h4>
                <p className="mt-2 text-base leading-7 text-slate-800 sm:text-lg sm:leading-8">
                  Healthcare data breaches reached an all‑time high in 2024, impacting 237.9 million U.S. residents. In Q1 2025, over 650 security incidents exposed sensitive information of more than 32 million people, escalating into a “mega‑breach era” in Q2 2025 with 14.8 million individuals affected, a 165% increase from Q1, despite a marginal decrease in incident volume. The average cost of a healthcare data breach remained the highest across all industries, exceeding $19.77 million per incident in 2024.
                </p>
              </div>
              <div>
                <h4 className="text-[#002856] font-semibold text-[20px] sm:text-[22px] md:text-[24px] leading-tight">Initial Access Vectors:</h4>
                <p className="mt-2 text-base leading-7 text-slate-800/70 sm:text-lg sm:leading-8 blur-[2px]">
                  Social engineering remained the leading initial access vector, accounting for 36% of incidents in Unit 42 incident response cases between May 2024 and May 2025, with over one‑third involving non‑phishing techniques. Mandiant reported exploits as the most frequent initial vector (33%) in 2024, followed by stolen credentials.
                </p>
              </div>
            </div>
            <div className="mt-6">
              <button type="button" onClick={() => setIsReportOpen(true)} className="inline-flex items-center gap-2 rounded-md bg-[#0000D3] px-5 py-3 text-sm font-bold text-white shadow-md hover:bg-blue-800">
      ...
      {/* Desktop Reputational Stakes section */}
      <section className="relative hidden h-[518px] bg-[#0050AC] xl:block">
        <div className="absolute left-[110px] top-[43px]">
          <h2 className="text-white text-[41px] font-bold leading-[50px] mb-8 w-[1053px]">When the stakes are reputational, not just technical. Exposure becomes a matter of timing and trust.</h2>
          <p className="text-white text-[22px] leading-[34px] mb-8 w-[853px]">We guide advisory boards, compliance heads and risk committees across industries where context matters most, from financial services and healthcare to critical infrastructure, SaaS, defense and more</p>
          <p className="text-white text-[22px] font-bold leading-[34px] mb-12 w-[785px]">This is intelligence that clarifies not just what happened, but what could.</p>
