            ...
            <div className="mt-6 space-y-6">
              <div>
                ...
                <p className="mt-2 text-base leading-7 text-slate-800 sm:text-lg sm:leading-8">
                  Threat actors are significantly reducing the time from initial compromise to data exfiltration or operational disruption, often achieving objectives in minutes to hours, necessitating real-time detection and automated response capabilities.
                </p>
              </div>
              <div>
                <h4 className="text-[#002856] font-semibold text-[20px] sm:text-[22px] md:text-[24px] leading-tight">
                ...
                <p className="mt-2 text-base leading-7 text-slate-800 sm:text-lg sm:leading-8">
                  Stolen credentials and social engineering, often enhanced by AI, are the leading initial access vectors, bypassing Multi-Factor Authentication (MFA) and exploiting human trust.
                </p>
              </div>
              <div>
                <h4 className="text-[#002856] font-semibold text-[20px] sm:text-[22px] md:text-[24px] leading-tight">
                  Ransomware's Destructive Evolution:
                </h4>
                <p className="mt-2 text-base leading-7 text-slate-800 sm:text-lg sm:leading-8">
                  Ransomware operations increasingly prioritize operational disruption and data destruction over mere encryption, with new groups emerging and established ones refining tactics for maximum impact and financial gain.
                </p>
              </div>
              <div>
                <h4 className="text-[#002856] font-semibold text-[20px] sm:text-[22px] md:text-[24px] leading-tight">
                ...
                <p className="mt-2 text-base leading-7 text-slate-800/70 sm:text-lg sm:leading-8 blur-[2px]">
                  Nation-state actors are actively pre-positioning capabilities within critical infrastructure for potential disruptive or destructive cyberattacks, while financially motivated groups continue to target these sectors for high-value extortion.
                </p>
              </div>
            </div>
            <div className="mt-6">
